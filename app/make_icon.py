"""Uygulama ikonunu üretir (Docker build sırasında bir kez çalışır)."""
import os
...
d.text((S / 2, 800 * k), "studio", font=font("FiraSansCondensed-Medium", 104 * k), fill=GREEN, anchor="ms")
